...
public class WordDocument {
    ...
    public WordDocument() {
        ...
        String template = System.getProperty("user.dir") + File.separator + "src" + File.separator + "test" + File.separator + "resources" + File.separator + "templates" + File.separator + "plantilla-evidencia.docx";
        //File output = new File(System.getProperty("user.dir") + "\\reportes\\word");
        File output = new File(System.getProperty("user.dir") + File.separator + "reportes" + File.separator + "word");
        //output.mkdir();
        if (!output.exists()) {
            output.mkdirs(); // Crear directorios si no existen
        }
        ...
        try {
            ...
            e.printStackTrace();
            throw new RuntimeException("No se pudo abrir el archivo de plantilla", e);

        }

        //fileName = output + "\\" + new TestUtils().dateTime() + ".docx";
        fileName = output + File.separator + new TestUtils().dateTime() + ".docx";
    }
